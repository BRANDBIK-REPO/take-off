...
export default function AboutHeader() {
  ...
  return (
    <section className="h-[70dvh] sm:h-[100dvh] relative bg-[var(--about-header-bg)] flex items-center justify-center pt-[120px] sm:pt-[100px] px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] text-[#215273] leading-[1.3] text-center px-4">
          <span className="font-serif not-italic font-normal">
            More Than a Network -{" "}
          </span>
          <br />
        ...
        <p className="text-[#506767] font-[300] max-w-[620px] mx-auto text-center text-sm sm:text-base px-4">
          Born in the UAE with deep Kerala–GCC roots, TakeOff connects SMEs,
          founders, and professionals who want to think bigger and achieve more.
        </p>
