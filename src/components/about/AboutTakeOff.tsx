        ...
        <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-2 flex flex-row lg:flex-col gap-12 lg:gap-16 justify-center lg:justify-start">
                        
                        <div className="flex flex-col items-center lg:items-start">
                            <div className="w-10 h-10 mb-3 flex items-center justify-center">
                                <GroupIcon />
                            </div>
                            <div className="text-5xl sm:text-6xl lg:text-7xl font-semibold text-[#506767] mb-2">7</div>
                        ...
                        <div className="flex flex-col items-center lg:items-start">
                            ...
                            <div className="text-5xl sm:text-6xl lg:text-7xl font-semibold text-[#506767] mb-2">500+</div>
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <div>
                            <p className="text-sm text-[#506767] mb-3 font-light">About TakeOff</p>
                            <h2 className="text-3xl text-[#215273] sm:text-4xl lg:text-5xl leading-tight mb-6">
                                <span className="font-serif font-normal">From local connections to </span>
                        ...
                        <div className="space-y-4 text-[#506767] font-light leading-relaxed">
                            ...
                            <p>
                                We are a trusted ecosystem where ambition-driven entrepreneurs come together to connect, collaborate, and scale. At TakeOff, relationships turn into partnerships, knowledge becomes strategy, and opportunities transform into results.
                            </p>
